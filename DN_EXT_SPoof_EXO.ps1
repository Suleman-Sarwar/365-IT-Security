# The following script will crate Exchange transport rule to prevent spoofing from external senders and agther all mailboxex

$ruleName = "Match Display Names with External Senders (Prevent Spoofing)"
...
if (!$rule) {
    Write-Host "Rule not exist, creating rule" -ForegroundColor Green
    ...
    Write-Host "Rule exist, updating rule" -ForegroundColor Green
