...
Write-Host "Microsoft Teams Process Sucessfully Stopped" -ForegroundColor Green
}catch{
echo $_
}
...
Write-Host "Internet Explorer and Microsoft Edge Processes Sucessfully Stopped" -ForegroundColor Green
}catch{
echo $_
}
...
Write-Host "Cleanup Complete and Launching Microsoft Teams" -ForegroundColor Green
